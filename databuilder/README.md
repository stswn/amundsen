...
dict_config = {
    ...
    f'loader.filesystem_csv_neo4j.{FsNeo4jCSVLoader.SHOULD_DELETE_CREATED_DIR}': True,
    f'extractor.es_indexes.{ElasticsearchMetadataExtractor.CLUSTER}': 'demo',
    f'extractor.es_indexes.{ElasticsearchMetadataExtractor.SCHEMA}': 'dev',
    f'extractor.es_indexes.{ElasticsearchMetadataExtractor.ELASTICSEARCH_CLIENT_CONFIG_KEY}': Elasticsearch()
}
...
dict_config = {
    ...
    f'loader.filesystem_csv_neo4j.{FsNeo4jCSVLoader.RELATION_DIR_PATH}': relationship_files_folder,
    f'loader.filesystem_csv_neo4j.{FsNeo4jCSVLoader.SHOULD_DELETE_CREATED_DIR}': True,
    f'extractor.es_indexes.{ElasticsearchColumnStatsExtractor.CLUSTER}': 'demo',
    f'extractor.es_indexes.{ElasticsearchColumnStatsExtractor.SCHEMA}': 'dev',
    f'extractor.es_indexes.{ElasticsearchColumnStatsExtractor.ELASTICSEARCH_CLIENT_CONFIG_KEY}': Elasticsearch()
}
